module spc_sn_735(
    ...
    wire  [2:0] out_raw;
    assign out_raw[0] = counter_array[0] | counter_array[2] | counter_array[4] | output_and;
    assign out_raw[1] = counter_array[1] | counter_array[2] | counter_array[5] | output_and;
    assign out_raw[2] = counter_array[3] | counter_array[4] | counter_array[5] | output_and;
