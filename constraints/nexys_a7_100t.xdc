...
set_property -dict { PACKAGE_PIN J15 IOSTANDARD LVCMOS33 } [get_ports { in[0] }]  # SW0
set_property -dict { PACKAGE_PIN L16 IOSTANDARD LVCMOS33 } [get_ports { in[1] }]  # SW1
set_property -dict { PACKAGE_PIN M13 IOSTANDARD LVCMOS33 } [get_ports { in[2] }]  # SW2
set_property -dict { PACKAGE_PIN R15 IOSTANDARD LVCMOS33 } [get_ports { in[3] }]  # SW3
set_property -dict { PACKAGE_PIN R17 IOSTANDARD LVCMOS33 } [get_ports { in[4] }]  # SW4
set_property -dict { PACKAGE_PIN T18 IOSTANDARD LVCMOS33 } [get_ports { in[5] }]  # SW5
set_property -dict { PACKAGE_PIN U18 IOSTANDARD LVCMOS33 } [get_ports { in[6] }]  # SW6

## Output mapping: 3-bit output 'out[2:0]' mapped to LEDs LD[2:0]
## These LEDs will show the binary count of '1's in the input
set_property -dict { PACKAGE_PIN H17 IOSTANDARD LVCMOS33 } [get_ports { out[0] }]  # LD0 (LSB)
set_property -dict { PACKAGE_PIN K15 IOSTANDARD LVCMOS33 } [get_ports { out[1] }]  # LD1
set_property -dict { PACKAGE_PIN J13 IOSTANDARD LVCMOS33 } [get_ports { out[2] }]  # LD2 (MSB)
